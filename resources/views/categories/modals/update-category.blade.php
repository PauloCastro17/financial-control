<div id="modal-update-category" class="modal fixed inset-0 flex items-start pt-10 justify-center bg-black/50 opacity-0 pointer-events-none transition-opacity duration-500" >
    <div class="w-250 bg-[#1C1A2E] rounded-lg transform scale-95 transition-all duration-300 modal-content">
        ...
        <form method="POST" action="{{ route('update.category') }}">
            ...
            <input name="id-category" type="hidden" id="id-category-modal-update-category" />
            ...
            <div class="gap-8 flex flex-col p-5">
                ...
                <div class="flex flex-col text-white gap-2">
                    ...
                    <input name="name_update" type="text" id="name-modal-update-category" placeholder="Insira o nome da categoria"  class="w-full border p-3 border-gray-600 rounded-xl" required/>
