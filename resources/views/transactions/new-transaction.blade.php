        ...
        <form method="POST" action="{{ route('create.new.transaction') }}">
            <div class="gap-8 flex flex-col p-5">
                ...
                <div class="flex flex-col text-white gap-2">
                    <label class="font-bold" for="select-beast">Categoria</label>
                    <select name="category" id="select-beast" placeholder="Escolha a categoria..." autocomplete="off" required>
                ...
                <div class="flex flex-col text-white gap-2">
                    <label class="font-bold" for="select-beast">Tipo (Entrada/Saída)</label>
                    <div>
                ...
                <div class="flex flex-col text-white gap-2">
                    <label class="font-bold" for="email">Valor</label>
            ...
            <div class="border-t-2 border-[#201E34] flex justify-end items-center p-5 gap-3">
                <div class="text-white hover:text-white/70 transition cursor-pointer bg-blue-700 p-2 border border-[#363A3F] rounded-lg w-26 hover:bg-[#282541]/40 flex items-center justify-center">
