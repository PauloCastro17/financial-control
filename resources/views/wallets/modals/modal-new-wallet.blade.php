<div id="modal-new-wallet" class="modal fixed inset-0 flex items-start pt-10 justify-center bg-black/50 opacity-0 pointer-events-none transition-opacity duration-500" >
    <div class="w-250 bg-[#1C1A2E] rounded-lg transform scale-95 transition-all duration-300 modal-content">
        ...
        <form method="POST" action="{{ route('create.new.wallet')  }}">
            @csrf
            ...
            <div class="gap-8 flex flex-col p-5">
                ...
                <div class="flex flex-col text-white gap-2">
                    ...
                    <input name="name" type="text" placeholder="Insira o nome da carteira"  class="w-full border p-3 border-gray-600 rounded-xl" required/>
                ...
                <div class="flex flex-col text-white gap-2">
                    <label class="font-bold" for="balance">Saldo Inicial</label>
                    <input name="balance" type="number" placeholder="Insira o saldo inicial da carteira"  class="w-full border p-3 border-gray-600 rounded-xl" required/>
                ...
                <div class="flex flex-col text-white gap-2">
                    <label class="font-bold" for="type">Tipo da carteira</label>
                    <select name="type" class="w-full border p-3 border-gray-600 rounded-xl" required>
